...
def load_pipeline_outputs(client, data_dir: str | Path, factor_name: str) -> dict[str, int]:
    ...
    optional_table_files = {
        ...
        "ads_strategy_optimization_report": root / "ads" / "strategy_optimization_report.parquet",
        "ads_candidate_validation_report": root / "ads" / "candidate_validation_report.parquet",
        "ads_candidate_yearly_validation": root / "ads" / "candidate_yearly_validation.parquet",
